                    ...
                    <div class="col">
                      ...
                      >
                        <flat-pickr
                          ...
                          v-model="form.dob"
                          :value="student.data.dob_formatted"
                        >
                        </flat-pickr>
                      </base-input>
...
export default {
  ...
  props: ["batches", "student"],
  data() {
    return {
      form: this.$inertia.form({
        batch_id: this.student.data.batch.id,
        name: this.student.data.name,
        enroll_no: this.student.data.enroll_no,
        dob: this.student.data.dob_formatted,
        dob_password: this.student.data.dob,
        active: this.student.data.active,
      }),
      notification: {
        status: false,
        type: "info",
  ...
  methods: {
    ...
    submit() {
      this.form.patch(
        this.$route("students.update", { id: this.student.data.id })
      );
    },
  },
  watch: {
